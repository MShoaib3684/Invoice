...
import {
    ...
    Image, Dimensions, TouchableOpacity, StyleSheet
} from 'react-native'
...
`} />
                ...
                <View style={{
                    ...
                    <Button onPress={() => refRBSheetEditCustomer.current.open()} />
                </View>
                <View style={{
                    flexDirection: 'row',
...
`} />
                    ...
                    <View style={{
                        ...
                        <TextInput placeholder="Name" xml={Svg.phone} />
                        <TextInput placeholder="Location" xml={Svg.phone} />
                        <TextInput placeholder="Phone No"
                            keyboardType="numeric"
                            xml={Svg.phone} />
                        <TextInput placeholder="Website" xml={Svg.globe} />
